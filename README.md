...
Goture is designed to be lightweight with minimal overhead:
...
- 📖 [Documentation](https://pkg.go.dev/github.com/goregion/goture)
- 🐛 [Issue Tracker](https://github.com/goregion/goture/issues)
- 💬 [Discussions](https://github.com/goregion/goture/discussions)

## Related Projects

- [Go Context Package](https://pkg.go.dev/context) - Official Go context package
- [Golang Concurrency Patterns](https://blog.golang.org/pipelines) - Official Go blog on concurrency
